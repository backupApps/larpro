                 ...
                 <tbody>
                  @foreach($data as $d)
                   <tr>
                     ...
                     <td><img src="{{ asset('storage/foto-user/'.$d->image) }}" alt="" width="90"></td>
                     <td>{{ $d->name }}</td>
                     <td>{{ $d->email }}</td>
                     <td>
                        <a href="{{ route('admin.user.edit', ['id' => $d->id]) }}" class="btn btn-primary"><i class="fas fa-pen"></i> Edit</a>
                        <a class="btn btn-danger" data-toggle="modal" data-target="#modal-hapus{{ $d->id }}"><i class="fas fa-trash-alt"></i> Hapus</a>
                     </td>
                   </tr>
